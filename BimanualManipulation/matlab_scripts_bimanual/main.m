...
pandaArm = InitRobot(model,wTb1,wTb2);
...
pandaArm.ArmL.wTg(1:3, 1:3) = pandaArm.ArmL.wTt * rotation(0, pi/6, 0);
pandaArm.ArmL.wTg (1:3, 4) = w_obj_g_left;
pandaArm.ArmR.wTg(1:3, 1:3) = pandaArm.ArmR.wTt * rotation(0, pi/6, 0);
...
for t = 0:dt:Tf
    ...
    xdot = zeros(12);
    xdot(1:6) = pandaArm.ArmL.xdot.alt;
    xdot(7:12) = pandaArm.ArmR.xdot.alt;
